...
export default function SellerSidebar() {
    ...
    const NAV = [
        ...
        { href: '/seller-dashboard/reviews', icon: Star, label: t('reviews') },
        { section: t('supportTickets') },
        { href: '/seller-dashboard/tickets', icon: MessageSquare, label: t('supportTickets') },
        { section: t('billing') },
